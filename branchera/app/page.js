            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 shadow-lg">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "The AI fact-checking is a game changer. Finally, a platform that prioritizes truth and meaningful dialogue over viral misinformation."
                </p>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 shadow-lg">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "The AI point extraction makes complex discussions so much easier to follow. Plus the one-heart system keeps everything authentic."
                </p>
                <div className="flex items-center">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 shadow-lg">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "The web search verification shows real sources for claims. I love having control over my content and seeing facts backed up with evidence."
                </p>
                <div className="flex items-center">
