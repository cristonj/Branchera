        ...
        <div className="relative flex flex-col items-center justify-center min-h-screen p-4 pt-20">
          <main className="text-center max-w-5xl w-full">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl mb-6 text-gray-700 font-light max-w-4xl mx-auto leading-relaxed">
              The AI-powered social platform where <span className="font-semibold text-blue-700">clarity and logic</span> beat distraction and misinformation
            </p>
            ...
            <div className="mt-24">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                ...
                <div className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:border-blue-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-blue-700 transition-colors">AI-Powered Fact Checking</h3>
                ...
                <div className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:border-purple-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-purple-700 transition-colors">Smart AI Point Extraction</h3>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <div className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:border-emerald-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                  <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                    <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-emerald-700 transition-colors">Web Search Verification</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Claims are verified against real web sources. See the actual search results and sources used to verify information.
                  </p>
                </div>

                {/* Thoughtful Text Discussions */}
                <div className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:border-orange-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                  <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                    <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-orange-700 transition-colors">Thoughtful Text Discussions</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Share your ideas through clear, well-crafted text. Express complex thoughts with precision and clarity in a distraction-free environment.
                  </p>
                </div>

                {/* One Heart Per User */}
                <div className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:border-pink-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                  <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                    <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-pink-700 transition-colors">One Heart Per User</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Prevent manipulation with our one-like-per-user system. Authentic engagement over artificial inflation and bot activity.
                  </p>
                </div>
                ...
                <div className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:border-indigo-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-indigo-700 transition-colors">Complete Content Control</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Delete your discussions and replies anytime. Your voice, your choice, your control. No permanent digital footprint worries.
                  </p>
                </div>

                {/* Real-Time Updates */}
                <div className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:border-cyan-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                  <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                    <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-cyan-700 transition-colors">Real-Time Updates</h3>
                  <p className="text-gray-600 leading-relaxed">
                    See engagement stats, fact-check results, and replies update instantly. Stay connected to live conversations as they evolve.
                  </p>
                </div>

                {/* Firebase Integration */}
                <div className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:border-amber-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                  <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                    <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-amber-700 transition-colors">Secure & Scalable</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Built on Firebase with Google authentication. Your data is secure, and the platform scales seamlessly with our growing community.
                  </p>
                </div>
                ...
                <div className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 hover:border-green-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                  <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                    <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728L5.636 5.636m12.728 12.728L5.636 5.636" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-green-700 transition-colors">Ad-Free Experience</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 shadow-lg">
                  ...
                  <p className="text-gray-700 mb-4 italic">
                    &ldquo;The AI fact-checking is a game changer. Finally, a platform that prioritizes truth and meaningful dialogue over viral misinformation.&rdquo;
                  </p>
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 shadow-lg">
                  ...
                  <p className="text-gray-700 mb-4 italic">
                    &ldquo;The AI point extraction makes complex discussions so much easier to follow. Plus the one-heart system keeps everything authentic.&rdquo;
                  </p>
                  <div className="flex items-center">
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 shadow-lg">
                  ...
                  <p className="text-gray-700 mb-4 italic">
                    &ldquo;The web search verification shows real sources for claims. I love having control over my content and seeing facts backed up with evidence.&rdquo;
                  </p>
                  <div className="flex items-center">
